...
1. `CLAUDE.md` — 모듈 구조·컨벤션·고정 규약의 단일 요약. 가장 신뢰.
...
- SpecKit(SDD): 기능마다 specs/에 spec→plan→tasks, TDD Red→Green→Refactor. 레포 자체 하네스는 `CLAUDE.md`의 "하네스: SpecKit·TDD 개발 팀" 참고(공부 하네스와 별개).
